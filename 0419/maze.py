...
def draw(screen, maze, player_pos, reached_goal, hit_wall_count):
    ...
    if reached_goal:
        ...
        text = font.render("Are you satisfied with your speed?", True, BLACK)
...
# 속도 설정 함수
def set_speed():
    speed = input("Please write down your pace of life (1-10): ")
    while not speed.isdigit() or int(speed) < 1 or int(speed) > 10:
        speed = input("Invalid input. Please enter a number between 1 and 10: ")
    return int(speed)
